...
class PlayerHolder(context: Context, private val playerState: PlayerState) : AnkoLogger {
    ...
    private fun buildMediaSource(uri: Uri): MediaSource {
        return ProgressiveMediaSource.Factory(DefaultHttpDataSourceFactory("exo-radiouci"))
    ...
    fun start() {
        // Load media.
        audioFocusPlayer.prepare(buildMediaSource(Uri.parse("http://149.56.147.197:8173/stream")))
